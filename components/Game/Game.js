...
const getGameStyles = (isHovered, isExpanded, hasLoaded) => ({
  ...
  boxShadow:
    ...
    '0 9px 17.5px rgba(50,50,93,.1),0 4px 7.5px rgba(0,0,0,.07)',
...
const Game = props => {
  switch (props.league) {
    ...
    case 'nba':
      return <NbaGame {...props} />
    case 'nfl':
      return <NflGame {...props} />
    case 'nhl':
...
const NbaGame = ({
  ...
  <li
    className={s.item}
    style={getGameStyles(isHovered, isExpanded, hasLoaded)}
  >
    <span
      className={s.topHalf}
      onClick={showDetails}
      onMouseEnter={scaleGame}
      onMouseLeave={scaleGame}
    >
      <GameState {...nbaGameStateProps(game)} />
      <Team
        {...nbaTeamProps(game, 'visitor', league)}
        hasLoaded={hasLoaded}
        logoHasLoaded={logoHasLoaded}
      />
      <Team
        {...nbaTeamProps(game, 'home', league)}
        hasLoaded={hasLoaded}
        logoHasLoaded={logoHasLoaded}
      />
...
const NflGame = ({
  ...
  >
    ...
    >
      ...
      <Team
        {...nflTeamProps(game, 'v', league)}
        hasLoaded={hasLoaded}
        logoHasLoaded={logoHasLoaded}
      />
      <Team
        {...nflTeamProps(game, 'h', league)}
        hasLoaded={hasLoaded}
        logoHasLoaded={logoHasLoaded}
      />
      <Expand isExpanded={isExpanded} />
...
const MlbGame = ({
  ...
  >
    ...
    >
      ...
      <Team
        {...mlbTeamProps(game, 'away', league)}
        hasLoaded={hasLoaded}
        logoHasLoaded={logoHasLoaded}
      />
      <Team
        {...mlbTeamProps(game, 'home', league)}
        hasLoaded={hasLoaded}
        logoHasLoaded={logoHasLoaded}
      />
      <Expand isExpanded={isExpanded} />
...
const NhlGame = ({
  ...
  >
    ...
    >
      ...
      <Team
        {...nhlTeamProps(game, 'away', league)}
        hasLoaded={hasLoaded}
        logoHasLoaded={logoHasLoaded}
      />
      <Team
        {...nhlTeamProps(game, 'home', league)}
        hasLoaded={hasLoaded}
        logoHasLoaded={logoHasLoaded}
      />
      <Expand isExpanded={isExpanded} />
